package top.codezx.common.plugin.logging.aop;
...
import top.codezx.common.plugin.logging.async.LoggingFactory;
...
public class LoggingAspect {
     ...
     * 切 面 编 程
     */
    @Pointcut("@annotation(top.codezx.common.plugin.logging.aop.annotation.Logging) || @within(top.codezx.common.plugin.logging.aop.annotation.Logging)")
